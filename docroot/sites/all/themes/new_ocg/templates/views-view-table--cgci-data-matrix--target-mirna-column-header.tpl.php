...
foreach ($rows as $row) {
  ...
  ?>
  <td class='outer colN' headers="<?php print $row['item_id_1']; ?>-rh mirna_ch <?php print $row['nid']; ?>-bn">
    <table class="cell">
      <tbody>
        <tr>
          <th id="<?php print $row['item_id_1']; ?>_mirna" scope="col" class="cellheader">
      <div class="cellheader"><?php print $header; ?></div>
    </th>
  </tr>
  <tr>
    <td class="cellbody" headers="<?php print $row['item_id_1']; ?>_rh mirna_ch <?php print $row['nid']; ?>_bn">
