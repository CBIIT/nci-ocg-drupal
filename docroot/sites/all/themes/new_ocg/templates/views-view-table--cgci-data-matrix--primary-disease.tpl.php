  ...
  <?php endforeach; ?>
      ...
      <?php endif; ?>
              <?php if ($patient_data->field_availability->value() == 'Protected'): ?>
                <a target="_blank" <?php print $link_title; ?> href='<?php print $patient_data->field_link->url->value(); ?>'><?php print $patient_data->field_link->title->value(); ?></a>
                <br />
            <?php endif; ?>
      ...
      <?php endif; ?>
          ...
          <?php endif; ?>
                    <?php if ($column_values->field_availability->value() == 'Protected'): ?>
                      <a target="_blank" <?php print $link_title; ?> href='<?php print $column_values->field_link->url->value(); ?>'><?php print $column_values->field_link->title->value(); ?></a>
                      <br />
                  <?php endif; ?>
